...
angular.module("materialCalendar").config(["materialCalendar.config", "$logProvider", "$compileProvider",
...
angular.module("materialCalendar").service("materialCalendar.Calendar", [
    function() {
...
angular.module("materialCalendar").service("MaterialCalendarData", [
    function() {
...
angular.module("materialCalendar").directive("calendarMd", ["$compile", "$parse", "$templateRequest", "$q", "materialCalendar.Calendar", "MaterialCalendarData",
    function($compile, $parse, $templateRequest, $q, Calendar, CalendarData) {
        ...
        // var defaultTemplate='template/caltemplate';
